...
std::string parsePushRule(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"parsePushRule"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "parsePushRule" << R"(","parsed":true)";
...
std::string matchPushRule(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"matchPushRule"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "matchPushRule" << R"(","ok":true)";
...
std::string buildPushRuleEvent(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"buildPushRuleEvent"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "buildPushRuleEvent" << R"(","ok":true)";
    o << R"(,"type":")" << type << R"(")";
