...
std::string formatMessagePreview(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatMessagePreview"})";
...
std::string formatSenderPrefix(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatSenderPrefix"})";
...
std::string getMessagePreviewIcon(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getMessagePreviewIcon" << R"(","ok":true)";
...
std::string buildImagePreview(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"buildImagePreview"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "buildImagePreview" << R"(","ok":true)";
    o << R"(,"type":")" << type << R"(")";
...
std::string buildVideoPreview(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"buildVideoPreview"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "buildVideoPreview" << R"(","ok":true)";
    o << R"(,"type":")" << type << R"(")";
    o << R"(,"content_size":)" << content.size();
    if (!format.empty()) o << R"(,"format":")" << format << R"(")";
    if (ts > 0) o << R"(,"timestamp":)" << ts;
...
std::string buildFilePreview(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"buildFilePreview"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "buildFilePreview" << R"(","ok":true)";
    o << R"(,"type":")" << type << R"(")";
    o << R"(,"content_size":)" << content.size();
    if (!format.empty()) o << R"(,"format":")" << format << R"(")";
    if (ts > 0) o << R"(,"timestamp":)" << ts;
...
std::string buildAudioPreview(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"buildAudioPreview"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "buildAudioPreview" << R"(","ok":true)";
    o << R"(,"type":")" << type << R"(")";
    o << R"(,"content_size":)" << content.size();
    if (!format.empty()) o << R"(,"format":")" << format << R"(")";
    if (ts > 0) o << R"(,"timestamp":)" << ts;
...
std::string buildStickerPreview(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"buildStickerPreview"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "buildStickerPreview" << R"(","ok":true)";
    o << R"(,"type":")" << type << R"(")";
    o << R"(,"content_size":)" << content.size();
    if (!format.empty()) o << R"(,"format":")" << format << R"(")";
    if (ts > 0) o << R"(,"timestamp":)" << ts;
...
std::string truncatePreview(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"truncatePreview"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "truncatePreview" << R"(","ok":true)";
