...
std::string scheduleTask(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"scheduleTask"})";
...
std::string cancelTask(const std::string& json) {
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "cancelTask" << R"(","result":)" << (result ? "true" : "false");
...
std::string getNextRunTime(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getNextRunTime" << R"(","ok":true)";
...
std::string taskExists(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"taskExists"})";
...
std::string listTasks(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"listTasks"})";
