...
std::string hashUserIdToColor(const std::string& json) {
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "hashUserIdToColor" << R"(","result":)" << (result ? "true" : "false");
...
std::string generateAvatarSvg(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"generateAvatarSvg"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "generateAvatarSvg" << R"(","ok":true)";
...
std::string blendColors(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"blendColors"})";
...
std::string getContrastText(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getContrastText" << R"(","ok":true)";
...
std::string formatAvatarHtml(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatAvatarHtml"})";
