...
std::string parseReadReceipt(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"parseReadReceipt"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "parseReadReceipt" << R"(","parsed":true)";
...
std::string buildReceiptEvent(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"buildReceiptEvent"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "buildReceiptEvent" << R"(","ok":true)";
    o << R"(,"type":")" << type << R"(")";
...
std::string getReadPosition(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getReadPosition" << R"(","ok":true)";
...
std::string getUnreadCount(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getUnreadCount" << R"(","ok":true)";
...
std::string formatReceiptAck(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatReceiptAck"})";
