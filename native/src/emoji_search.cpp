...
std::string searchEmoji(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"searchEmoji"})";
...
std::string getEmojiByCategory(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getEmojiByCategory" << R"(","ok":true)";
...
std::string getEmojiVariations(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getEmojiVariations" << R"(","ok":true)";
...
std::string isValidEmojiCodepoint(const std::string& json) {
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "isValidEmojiCodepoint" << R"(","result":)" << (result ? "true" : "false");
...
std::string formatEmojiPicker(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatEmojiPicker"})";
