...
std::string parseVoiceBroadcastInfo(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"parseVoiceBroadcastInfo"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "parseVoiceBroadcastInfo" << R"(","parsed":true)";
...
std::string buildVoiceBroadcastEvent(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"buildVoiceBroadcastEvent"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "buildVoiceBroadcastEvent" << R"(","ok":true)";
    o << R"(,"type":")" << type << R"(")";
...
std::string getVoiceBroadcastState(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getVoiceBroadcastState" << R"(","ok":true)";
...
std::string canStartVoiceBroadcast(const std::string& json) {
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "canStartVoiceBroadcast" << R"(","result":)" << (result ? "true" : "false");
