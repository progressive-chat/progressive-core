...
std::string getUserSuggestions(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getUserSuggestions" << R"(","ok":true)";
...
std::string getEmojiSuggestions(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getEmojiSuggestions" << R"(","ok":true)";
...
std::string getRoomSuggestions(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getRoomSuggestions" << R"(","ok":true)";
...
std::string rankSuggestions(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"rankSuggestions"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "rankSuggestions" << R"(","ok":true)";
...
std::string formatSuggestionHtml(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatSuggestionHtml"})";
