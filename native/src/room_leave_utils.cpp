...
std::string buildLeaveRequest(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty_input"})";
    std::ostringstream oss;
    oss << R"({"ok":true,"method":")" << "buildLeaveRequest" << R"(","size":)" << json.size();
...
std::string buildKickRequest(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty_input"})";
    std::ostringstream oss;
    oss << R"({"ok":true,"method":")" << "buildKickRequest" << R"(","size":)" << json.size();
...
std::string buildBanRequest(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty_input"})";
    std::ostringstream oss;
    oss << R"({"ok":true,"method":")" << "buildBanRequest" << R"(","size":)" << json.size();
...
std::string buildUnbanRequest(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty_input"})";
    std::ostringstream oss;
    oss << R"({"ok":true,"method":")" << "buildUnbanRequest" << R"(","size":)" << json.size();
