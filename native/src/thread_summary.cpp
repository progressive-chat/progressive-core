...
std::string getThreadCount(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getThreadCount" << R"(","ok":true)";
...
std::string getLatestThreadEvent(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getLatestThreadEvent" << R"(","ok":true)";
...
std::string isParticipating(const std::string& json) {
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "isParticipating" << R"(","result":)" << (result ? "true" : "false");
...
std::string formatThreadPreview(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatThreadPreview"})";
...
std::string getUnreadThreads(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getUnreadThreads" << R"(","ok":true)";
