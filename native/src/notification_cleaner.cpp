...
std::string clearNotification(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"clearNotification"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "clearNotification" << R"(","ok":true)";
...
std::string dismissAll(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"dismissAll"})";
...
std::string isNotificationActive(const std::string& json) {
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "isNotificationActive" << R"(","result":)" << (result ? "true" : "false");
...
std::string getActiveNotifications(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getActiveNotifications" << R"(","ok":true)";
...
std::string formatClearAction(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatClearAction"})";
