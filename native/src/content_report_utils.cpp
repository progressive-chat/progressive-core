...
std::string buildReport(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"buildReport"})";
...
std::string parseReportResponse(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"parseReportResponse"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "parseReportResponse" << R"(","parsed":true)";
...
std::string validateReportReason(const std::string& json) {
    if (json.empty()) return R"({"valid":false,"error":"empty input","fn":"validateReportReason"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "validateReportReason" << R"(","valid":)" << (valid ? "true" : "false");
...
std::string getReportCategories(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getReportCategories" << R"(","ok":true)";
...
std::string formatReportNotice(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatReportNotice"})";
