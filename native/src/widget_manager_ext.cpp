...
std::string parseWidgetConfig(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"parseWidgetConfig"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "parseWidgetConfig" << R"(","parsed":true)";
...
std::string validateWidgetDomain(const std::string& json) {
    if (json.empty()) return R"({"valid":false,"error":"empty input","fn":"validateWidgetDomain"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "validateWidgetDomain" << R"(","valid":)" << (valid ? "true" : "false");
...
std::string sendWidgetMessage(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"sendWidgetMessage"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "sendWidgetMessage" << R"(","ok":true)";
...
std::string formatWidgetLoad(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatWidgetLoad"})";
