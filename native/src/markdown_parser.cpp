...
std::string parseMarkdown(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"parseMarkdown"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "parseMarkdown" << R"(","parsed":true)";
...
std::string extractHeadings(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"extractHeadings"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "extractHeadings" << R"(","parsed":true)";
    if (!eventId.empty()) o << R"(,"event_id":")" << eventId << R"(")";
    if (!roomId.empty()) o << R"(,"room_id":")" << roomId << R"(")";
    if (!userId.empty()) o << R"(,"user_id":")" << userId << R"(")";
    if (!type.empty()) o << R"(,"type":")" << type << R"(")";
...
std::string extractLinks(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"extractLinks"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "extractLinks" << R"(","parsed":true)";
    if (!eventId.empty()) o << R"(,"event_id":")" << eventId << R"(")";
    if (!roomId.empty()) o << R"(,"room_id":")" << roomId << R"(")";
    if (!userId.empty()) o << R"(,"user_id":")" << userId << R"(")";
    if (!type.empty()) o << R"(,"type":")" << type << R"(")";
...
std::string extractCodeBlocks(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"extractCodeBlocks"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "extractCodeBlocks" << R"(","parsed":true)";
    if (!eventId.empty()) o << R"(,"event_id":")" << eventId << R"(")";
    if (!roomId.empty()) o << R"(,"room_id":")" << roomId << R"(")";
    if (!userId.empty()) o << R"(,"user_id":")" << userId << R"(")";
    if (!type.empty()) o << R"(,"type":")" << type << R"(")";
...
std::string sanitizeMarkdown(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"sanitizeMarkdown"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "sanitizeMarkdown" << R"(","ok":true)";
