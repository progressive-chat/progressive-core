...
std::string backupKeys(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"backupKeys"})";
...
std::string restoreKeys(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"restoreKeys"})";
...
std::string getBackupVersion(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getBackupVersion" << R"(","ok":true)";
...
std::string deleteBackup(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"deleteBackup"})";
...
std::string formatBackupStatus(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatBackupStatus"})";
