...
std::string setFontScale(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"setFontScale"})";
...
std::string getAvailableFonts(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getAvailableFonts" << R"(","ok":true)";
...
std::string applyFont(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"applyFont"})";
...
std::string formatFontPreview(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatFontPreview"})";
