...
std::string getPowerLevelColor(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getPowerLevelColor" << R"(","ok":true)";
...
std::string getPowerLevelIcon(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getPowerLevelIcon" << R"(","ok":true)";
...
std::string formatPowerBadge(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatPowerBadge"})";
...
std::string getPowerDescription(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getPowerDescription" << R"(","ok":true)";
...
std::string parsePowerLevels(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"parsePowerLevels"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "parsePowerLevels" << R"(","parsed":true)";
