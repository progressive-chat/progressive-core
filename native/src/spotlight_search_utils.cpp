...
std::string searchAll(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"searchAll"})";
...
std::string getRecentSearches(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getRecentSearches" << R"(","ok":true)";
...
std::string clearRecent(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"clearRecent"})";
...
std::string indexContent(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"indexContent"})";
...
std::string formatSearchResult(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatSearchResult"})";
