...
std::string getMediaEvents(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getMediaEvents" << R"(","ok":true)";
...
std::string groupByDate(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"groupByDate"})";
...
std::string getThumbForEvent(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getThumbForEvent" << R"(","ok":true)";
...
std::string getMediaCount(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getMediaCount" << R"(","ok":true)";
...
std::string formatGalleryView(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatGalleryView"})";
