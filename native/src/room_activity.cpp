...
std::string getLastActivity(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getLastActivity" << R"(","ok":true)";
...
std::string isRoomActive(const std::string& json) {
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "isRoomActive" << R"(","result":)" << (result ? "true" : "false");
...
std::string getMessageFrequency(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getMessageFrequency" << R"(","ok":true)";
...
std::string formatActivitySummary(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatActivitySummary"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "formatActivitySummary" << R"(")";
    o << R"(,"len":)" << text.length();
    o << R"(,"words":)" << wordCount;
    o << R"(,"lines":)" << lineCount;
...
std::string sortByActivity(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"sortByActivity"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "sortByActivity" << R"(","ok":true)";
