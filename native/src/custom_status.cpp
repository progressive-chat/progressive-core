...
std::string parseStatus(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"parseStatus"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "parseStatus" << R"(","parsed":true)";
...
std::string setStatus(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"setStatus"})";
...
std::string expireStatus(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"expireStatus"})";
...
std::string getUserStatusText(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getUserStatusText" << R"(","ok":true)";
...
std::string formatStatusEmoji(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatStatusEmoji"})";
