...
std::string setAvatarUrl(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"setAvatarUrl"})";
...
std::string removeAvatar(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"removeAvatar"})";
...
std::string cropAvatar(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"cropAvatar"})";
...
std::string formatAvatarEvent(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatAvatarEvent"})";
