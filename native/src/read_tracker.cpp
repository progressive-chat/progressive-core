...
std::string markRead(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"markRead"})";
...
std::string isRead(const std::string& json) {
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "isRead" << R"(","result":)" << (result ? "true" : "false");
...
std::string getUnreadPosition(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getUnreadPosition" << R"(","ok":true)";
...
std::string getReadReceipts(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getReadReceipts" << R"(","ok":true)";
...
std::string formatReadStatus(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatReadStatus"})";
