...
std::string parseTypingEvent(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"parseTypingEvent"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "parseTypingEvent" << R"(","parsed":true)";
...
std::string isTyping(const std::string& json) {
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "isTyping" << R"(","result":)" << (result ? "true" : "false");
...
std::string getTypingTimeout(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getTypingTimeout" << R"(","ok":true)";
...
std::string formatTypingList(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatTypingList"})";
...
std::string buildTypingNotification(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"buildTypingNotification"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "buildTypingNotification" << R"(","ok":true)";
    o << R"(,"type":")" << type << R"(")";
