...
std::string getSuggestedRooms(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getSuggestedRooms" << R"(","ok":true)";
...
std::string getTrendingRooms(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getTrendingRooms" << R"(","ok":true)";
...
std::string getPopularRooms(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getPopularRooms" << R"(","ok":true)";
...
std::string filterByLanguage(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"filterByLanguage"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "filterByLanguage" << R"(","ok":true)";
...
std::string formatRoomSuggestion(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"fn":"formatRoomSuggestion"})";
