...
std::string checkPermission(const std::string& json) {
    if (json.empty()) return R"({"valid":false,"error":"empty input","fn":"checkPermission"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "checkPermission" << R"(","valid":)" << (valid ? "true" : "false");
...
std::string requestPermission(const std::string& json) {
    if (json.empty()) return R"({"ok":false,"error":"empty input","fn":"requestPermission"})";
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "requestPermission" << R"(","ok":true)";
...
std::string getDeniedCount(const std::string& json) {
    std::ostringstream o;
    o << R"({"fn":")" << "getDeniedCount" << R"(","ok":true)";
...
std::string isPermanentlyDenied(const std::string& json) {
    ...
    std::ostringstream o;
    o << R"({"fn":")" << "isPermanentlyDenied" << R"(","result":)" << (result ? "true" : "false");
